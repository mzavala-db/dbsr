<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HorasVendidasReport.aspx.cs" Inherits="DBSR2.HorasVendidasReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoTitulo" runat="server">
Reporte de horas aplicadas
</asp:Content>
